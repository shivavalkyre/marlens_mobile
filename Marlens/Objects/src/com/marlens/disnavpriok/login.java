...
public class login extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.marlens.disnavpriok", "com.marlens.disnavpriok.login");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.marlens.disnavpriok", "com.marlens.disnavpriok.login");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.marlens.disnavpriok.login", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 26;BA.debugLine="Activity.LoadLayout(\"Login\")";
...
mostCurrent._ph.SetScreenOrientation(processBA,(int) (1));
 //BA.debugLineNum = 28;BA.debugLine="general.SetBackgroundTintList(txtUsername, Colors";
mostCurrent._general._setbackgroundtintlist /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._txtusername.getObject())),anywheresoftware.b4a.keywords.Common.Colors.White,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 29;BA.debugLine="general.SetBackgroundTintList(txtPassword, Colors";
mostCurrent._general._setbackgroundtintlist /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._txtpassword.getObject())),anywheresoftware.b4a.keywords.Common.Colors.White,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 30;BA.debugLine="general.EditTextUsername(txtUsername)";
mostCurrent._general._edittextusername /*String*/ (mostCurrent.activityBA,mostCurrent._txtusername);
 //BA.debugLineNum = 31;BA.debugLine="general.EditTextPassword(txtPassword)";
...
public ResumableSub_Button1_Click(com.marlens.disnavpriok.login parent) {
this.parent = parent;
}
com.marlens.disnavpriok.login parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 62;BA.debugLine="If txtUsername.Text.Length>0 And txtPassword.Text";
if (true) break;
...
_j = new com.marlens.disnavpriok.httpjob();
 //BA.debugLineNum = 64;BA.debugLine="Dim parameter As String =\"username=\"&txtUsername";
_parameter = "username="+parent.mostCurrent._txtusername.getText()+"&password="+parent.mostCurrent._txtpassword.getText();
 //BA.debugLineNum = 65;BA.debugLine="j.Initialize(\"j\",Me)";
_j._initialize /*String*/ (processBA,"j",login.getObject());
 //BA.debugLineNum = 66;BA.debugLine="j.PostString (url_login,parameter)";
...
//C
this.state = 7;
 //BA.debugLineNum = 70;BA.debugLine="Dim result = j.GetString";
_result = _j._getstring /*String*/ ();
 //BA.debugLineNum = 71;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 72;BA.debugLine="parser.Initialize(result)";
_parser.Initialize(_result);
 //BA.debugLineNum = 73;BA.debugLine="Dim root As Map = parser.NextObject";
_root = new anywheresoftware.b4a.objects.collections.Map();
_root = _parser.NextObject();
 //BA.debugLineNum = 74;BA.debugLine="Dim level As Int = root.Get(\"level\")";
_level = (int)(BA.ObjectToNumber(_root.Get((Object)("level"))));
 //BA.debugLineNum = 75;BA.debugLine="Dim id As String = root.Get(\"id\")";
_id = BA.ObjectToString(_root.Get((Object)("id")));
 //BA.debugLineNum = 76;BA.debugLine="Dim token As String = root.Get(\"token\")";
_token = BA.ObjectToString(_root.Get((Object)("token")));
 //BA.debugLineNum = 77;BA.debugLine="Dim username As String = root.Get(\"username\")";
_username = BA.ObjectToString(_root.Get((Object)("username")));
 //BA.debugLineNum = 78;BA.debugLine="StartActivity(Home)";
...
mostCurrent._txtpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private ClickStatus As Int = 0";
_clickstatus = (int) (0);
...
mostCurrent._button1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private ph As Phone";
...
public static String  _label2_click() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Private Sub Label2_Click";
...
public static String  _txtpassword_click() throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Private Sub txtPassword_Click";
 //BA.debugLineNum = 44;BA.debugLine="If ClickStatus=0 Then";
if (_clickstatus==0) { 
 //BA.debugLineNum = 45;BA.debugLine="general.EditTextPassword1(txtPassword)";
mostCurrent._general._edittextpassword1 /*String*/ (mostCurrent.activityBA,mostCurrent._txtpassword);
 //BA.debugLineNum = 46;BA.debugLine="ClickStatus=1";
_clickstatus = (int) (1);
 //BA.debugLineNum = 48;BA.debugLine="txtPassword.PasswordMode=False";
mostCurrent._txtpassword.setPasswordMode(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 50;BA.debugLine="general.EditTextPassword(txtPassword)";
mostCurrent._general._edittextpassword /*String*/ (mostCurrent.activityBA,mostCurrent._txtpassword);
 //BA.debugLineNum = 51;BA.debugLine="ClickStatus=0";
_clickstatus = (int) (0);
 //BA.debugLineNum = 52;BA.debugLine="txtPassword.PasswordMode=True";
